---
title: |
  | \vspace{-1.8cm}**DS 223: Marketing Analytics**  
...
Moreover, another similarity is that both the electric toothbrush and the Samba Robotic Toothbrush are electric devices designed to alleviate the physical demands of traditional brushing methods. Hence, they belong to the same category of products.
...
initial_params <- c(sum(sales), 0.02, 0.4)

# Use optim with Nelder-Mead method
optim_result <- optim(par = initial_params, fn = residuals_function, method = "BFGS")
